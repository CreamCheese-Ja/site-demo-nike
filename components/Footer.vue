    ...
    <div class="o-layout-footer">
      <div class="content">
        <div class="menuArea">
          <ul class="menu">
            <li class="menuItem">
              <a href="" class="link">NIKEギフトカード</a>
            </li>
            <li class="menuItem">
              <a href="" class="link">10%学生・教職員割引</a>
            </li>
            <li class="menuItem">
              <a href="" class="link">最寄りの店舗</a>
            </li>
            <li class="menuItem">
              <a href="" class="link">メンバー登録</a>
            </li>
            <li class="menuItem">
              <a href="" class="link">コンビニ受け取りサービス</a>
            </li>
            <li class="menuItem">
              <a href="" class="link">最新情報を受け取る</a>
            </li>
            <li class="menuItem">
              <a href="" class="link">フィードバックをお寄せください</a>
            </li>
          </ul>
          <ul class="menu">
            <li class="menuItem -sub">
              <a href="" class="link">ヘルプ</a>
            </li>
            <li class="menuItem -sub">
              <a href="" class="link -sub">注文履歴</a>
            </li>
            <li class="menuItem -sub">
              <a href="" class="link -sub">配送と発送</a>
            </li>
            <li class="menuItem -sub">
              <a href="" class="link -sub">返品</a>
            </li>
            <li class="menuItem -sub">
              <a href="" class="link -sub">交換</a>
            </li>
            <li class="menuItem -sub">
              <a href="" class="link -sub">支払いオプション</a>
            </li>
            <li class="menuItem -sub">
              <a href="" class="link -sub">お問い合わせ</a>
            </li>
          </ul>
          <ul class="menu">
            <li class="menuItem -sub">
              <a href="" class="link">ナイキについて</a>
            </li>
            <li class="menuItem -sub">
              <a href="" class="link -sub">ニュース</a>
            </li>
            <li class="menuItem -sub">
              <a href="" class="link -sub">採用情報</a>
            </li>
            <li class="menuItem -sub">
              <a href="" class="link -sub">投資家向け情報(英語)</a>
            </li>
            <li class="menuItem -sub">
              <a href="" class="link -sub">サステナビリティ</a>
            </li>
            <li class="menuItem -sub">
              <a href="" class="link -sub">NIKEギフトカードについて</a>
            </li>
          </ul>
        </div>
        <div class="iconArea">
