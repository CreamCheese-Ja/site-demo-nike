    ...
    <div class="layout-footer">
      <div class="content">
        <div class="menu-area">
          <ul class="menu">
            <li class="menu-item">
              <nuxt-link to="/" class="link">NIKEギフトカード</nuxt-link>
            </li>
            <li class="menu-item">
              <nuxt-link to="/" class="link">10%学生・教職員割引</nuxt-link>
            </li>
            <li class="menu-item">
              <nuxt-link to="/" class="link">最寄りの店舗</nuxt-link>
            </li>
            <li class="menu-item">
              <nuxt-link to="/" class="link">メンバー登録</nuxt-link>
            </li>
            <li class="menu-item">
              <nuxt-link to="/" class="link"
                >コンビニ受け取りサービス</nuxt-link
              >
            </li>
            <li class="menu-item">
              <nuxt-link to="/" class="link">最新情報を受け取る</nuxt-link>
            </li>
            <li class="menu-item">
              <nuxt-link to="/" class="link"
                >フィードバックをお寄せください</nuxt-link
              >
            </li>
          </ul>
          <ul class="menu">
            ...
            <li class="menu-item -sub">
              <nuxt-link to="/" class="link -sub">注文履歴</nuxt-link>
            </li>
            <li class="menu-item -sub">
              <nuxt-link to="/" class="link -sub">配送と発送</nuxt-link>
            </li>
            <li class="menu-item -sub">
              <nuxt-link to="/" class="link -sub">返品</nuxt-link>
            </li>
            <li class="menu-item -sub">
              <nuxt-link to="/" class="link -sub">交換</nuxt-link>
            </li>
            <li class="menu-item -sub">
              <nuxt-link to="/" class="link -sub">支払いオプション</nuxt-link>
            </li>
            <li class="menu-item -sub">
              <nuxt-link to="/" class="link -sub">お問い合わせ</nuxt-link>
            </li>
          </ul>
          <ul class="menu">
            <li class="menu-item -sub">
              <nuxt-link to="/" class="link">ナイキについて</nuxt-link>
            </li>
            <li class="menu-item -sub">
              <nuxt-link to="/" class="link -sub">ニュース</nuxt-link>
            </li>
            <li class="menu-item -sub">
              <nuxt-link to="/" class="link -sub">採用情報</nuxt-link>
            </li>
            <li class="menu-item -sub">
              <nuxt-link to="/" class="link -sub"
                >投資家向け情報(英語)</nuxt-link
              >
            </li>
            <li class="menu-item -sub">
              <nuxt-link to="/" class="link -sub">サステナビリティ</nuxt-link>
            </li>
            <li class="menu-item -sub">
              <nuxt-link to="/" class="link -sub"
                >NIKEギフトカードについて</nuxt-link
              >
            </li>
          </ul>
        </div>
